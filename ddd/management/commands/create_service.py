...
class CreateServiceCommand:
    ...
    def execute(self, args):
        self.create_service(args.app_path, args.service_name, args.entity_name, args.class_format, args.split)

    def create_service(self, app_path, service_name="Manage", entity_name="Entity", class_format=False, split=False, **kwargs):
