class [[ serializer_name|capitalize_first ]]DTOSerializer(serializers.Serializer):
    ...
    Ejemplos de: 
        ...
        rating = serializers.DecimalField(max_digits=3, decimal_places=2, help_text="Valoración media (ej. 4.5 estrellas)") 
        ...
        latitude = serializers.DecimalField(max_digits=9, decimal_places=6, allow_null=True, help_text="Coordenada de latitud")
        longitude = serializers.DecimalField(max_digits=9, decimal_places=6, allow_null=True, help_text="Coordenada de longitud") 
        ...
        order_status = serializers.ChoiceField(
            ...
            allow_null=True, 
            help_text="Estado de la orden (e.g., 'PENDING', 'COMPLETED')"
        )
        ...
        categories = serializers.ListField(
            ...
            allow_null=True, 
            help_text="Lista de categorías asociadas ej. ['electronics', 'clothing']")
        items = serializers.ListField(
            child=serializers.DictField(), 
            allow_null=True, 
            help_text="Lista de artículos asociados ej. [{'product_id': 1, 'quantity': 2}, {'product_id': 2, 'quantity': 1}]"
        )
